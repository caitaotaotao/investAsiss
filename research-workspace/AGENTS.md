...
| **stock-rationale-card** | "分析XX股票"、"生成投资卡片"、"跟踪XX投资逻辑" | 生成与维护个股投资逻辑卡片；输出至 `/app/custom/research-workspace/knowledge/stock-rationale-card/{代码}_{交易所小写}.md`；含周期定位、成长驱动、风险评估等六大模块 |
